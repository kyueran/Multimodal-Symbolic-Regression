...
python train.py --reload_model_snipenc ./weights/numeric512k.pth --reload_model_e2edec ./weights/e2e.pth --freeze_encoder True --batch_size 64 --dump_path ./dump --max_input_dimension 10 --n_steps_per_epoch 1000 --max_epoch 100000 --exp_name snipe2e --exp_id numeric512k --lr 4e-5 --latent_dim 512 --save_periodic 1 --n_dec_layers 16
